...
By using Cache, you agree to these terms. If you don't agree, don't use the app.
...
**You own them.** We never see, access, or store your content.

**You're responsible for them.** What you write and store is your business.

## Your Responsibilities

- Use Cache lawfully
- Keep your git credentials secure
- Maintain backups (your git repo is your backup)
- Don't reverse-engineer or abuse the software
...
We may update these terms. Continued use means acceptance. We'll notify you of significant changes via the app.
